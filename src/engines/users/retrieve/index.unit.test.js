/**
 * src/engines/users/retrieve/index.unit.test.js
 */
...
describe('Engine - Users - Retrieve', function () {
  ...
  function () {
    ...
    it("should call the client instance's get method with the correct params",
    function () {
  ...
  function () {
    ...
    it('should return with a promise that resolves to an object',
    function () {
  ...
  function () {
    ...
    describe('Because the user does not exist',
    function () {
      beforeEach(function () {
        db = {
