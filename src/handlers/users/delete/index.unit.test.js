/**
 * src/handlers/users/delete/index.unit.test.js
 */
...
// const NOT_FOUND_ERROR_MESSAGEtwo = 'Not Found';
// const GENERIC_ERROR_MESSAGEtwo = 'Internal Server Error';
// const genny = {
//   success: stub().resolves(undefined),
//   notFoundError: stub().rejects(new Error(NOT_FOUND_ERROR_MESSAGEtwo)),
//   genericError: stub().rejects(new Error(GENERIC_ERROR_MESSAGEtwo)),
// };
...
describe('Handler - Users - Delete', function () {
  ...
  describe('When called with valid request object', function () {
    beforeEach(function () {
      ...
      const engine = generateDeleteUserStubs().success;
      // const engine = genny.success;
      // const engine = Promise.resolve();
