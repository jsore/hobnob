/**
 * src/handlers/users/retrieve/index.unit.test.js
 */

import assert from 'assert';
import { match } from 'sinon';
import generateResSpy from '../../../tests/spies/res';
import generateRetrieveUserStubs, { RETRIEVE_USER_RESPONSE_OBJECT }
...
describe('Handler - Users - Retrieve', function () {
  ...
  function () {
    ...
    it('should res.set() with a application/json content-type header',
    function () {
    ...
    it('should call res.send() with the object returned from retrieveUser',
    function () {
  ...
  function () {
    ...
    it('should call res.json() with an error object message "Not Found"',
    function () {
      assert(res.json.calledWithExactly(
        match.has('message', 'Not Found')
      ));
    });
  });
  ...
  function () {
    ...
    it('should call res.json() with an error object message "Internal Server Error"',
    function () {
      assert(res.json.calledWithExactly(
