# hobnob/spec/cucumber/features/profile/replace/main.feature
...
#
#   If the client sends a PUT request to /users/:userId/profile
...
#
#     When the client creates a PUT request to /usere/:userId/profile
#     And attaches a valid Replace User Profile payload
#     And sends the request
