# hobnob/spec/cucumber/features/users/search/main.feature

Feature: Search Users

  Clients should be able to send a request to our API in
  order to search users based on parameters.
  ...
  Scenario Outline: When there are 10 or fewer users
  # display a default view of 10 users
