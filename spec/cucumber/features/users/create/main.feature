...
Feature: Create User
  ...
  Scenario Outline: Invalid Profile
    ...
    | {"email":"e@ma.il","password":"abc","profile":{"name":"Jane Doe"}}               | The '.profile.name' field must be of type object          |
  ...
  # success scenario with valid profile payload
